...
<%@ Register Src="~/controls/ValidarAltaProducto.ascx" TagPrefix="uc" TagName="ValidarAltaProducto" %>
...
<head runat="server">
    ...
    <style>
        ...
        .content { max-width: 900px; margin: 80px auto; padding: 40px; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1); }
    ...
    <form runat="server">
        <div class="content">
            ...
            <asp:Panel ID="PanelAltaProducto" runat="server">
                <div class="row">
                    <uc:ValidarAltaProducto ID="ValidarAltaProductoControl" runat="server" />
                </div>
